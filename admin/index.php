							...
							<div class="dashboard-content-panel-wrapper">
								<div class="dashboard-content-panel-header">
									...
									<div class="input-instructions input-instructions-m-t">
										...
										<div>
											You need to connect your domain name with your license key inside <a href="https://www.cpazip.com/" target="_blank">customer profile</a> on our website, as the landing page will function properly only on connected domains.
										</div>
									</div>
								</div>
		...
		<?php if (htmlspecialchars(isset($_GET['rmsg'])) && htmlspecialchars($_GET['rmsg']) == 'led') {?>
			<script>
				$(document).ready(function() {
					Swal.fire({
					  title: 'Error!',
					  html: 'Your license key is active - CPAZip.com',
					  icon: 'error',
					  confirmButtonText: 'Ok'
					})
				});
