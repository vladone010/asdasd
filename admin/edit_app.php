				...
				<div class="mr-side-nav">
					<div class="mr-side-nav-ha">
						...
						<div class="mr-side-nav-group">
							...
							<ul>
								...
								<li class="nav-item">
									<div class="nav-link"><i class="material-icons-two-tone">alternate_email</i><div><span>Email:</span> contact@cpazip.com</div></div>
								</li>
							</ul>						
						</div>
					</div>
					<div class="ac-wrapper">
						<div class="ac-inner-wrapper">
							<a href="https://www.cpazip.com.com/" target="_blank">
								www.cpazip.com
							</a>
						</div>
					</div>
		...
		<?php if (htmlspecialchars(isset($_GET['rmsg'])) && htmlspecialchars($_GET['rmsg']) == 'led') {?>
			<script>
				$(document).ready(function() {
					Swal.fire({
					  title: 'Error!',
					  html: 'Your license key is active - CPAZip.com</div>',
					  icon: 'error',
					  confirmButtonText: 'Ok'
					})
				});
